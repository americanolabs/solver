...
export interface Hyperlane7683Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "FILLED" | "OPENED" | "PACKAGE_VERSION" | "PERMIT2" | "REFUNDED" | "RESOLVED_CROSS_CHAIN_ORDER_TYPEHASH" | "SETTLED" | "UNKNOWN" | "destinationGas" | "domains" | "enrollRemoteRouter" | "enrollRemoteRouters" | "fill" | "filledOrders" | "handle" | "hook" | "initialize" | "interchainSecurityModule" | "invalidateNonces" | "isValidNonce" | "localDomain" | "mailbox" | "open" | "openFor" | "openOrders" | "orderStatus" | "owner" | "quoteGasPayment" | "refund((uint32,bytes32,bytes)[])" | "refund((address,address,uint256,uint256,uint32,uint32,bytes32,bytes)[])" | "renounceOwnership" | "resolve" | "resolveFor" | "routers" | "setDestinationGas(uint32,uint256)" | "setDestinationGas((uint32,uint256)[])" | "setHook" | "setInterchainSecurityModule" | "settle" | "transferOwnership" | "unenrollRemoteRouter" | "unenrollRemoteRouters" | "usedNonces" | "witnessHash" | "witnessTypeString"): FunctionFragment;
