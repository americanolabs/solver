...
export interface Hyperlane7683 extends BaseContract {
  ...
  functions: {
    ...
    filledOrders(
      orderId: BytesLike,
      overrides?: CallOverrides
    ): Promise<[string, string] & { originData: string; fillerData: string }>;
    ...
    openOrders(
      orderId: BytesLike,
      overrides?: CallOverrides
    ): Promise<[string] & { orderData: string }>;
  ...
  filters: {
    ...
    "NonceInvalidation(address,uint256)"(
      owner?: string | null,
      nonce?: null
    ...
    "Open(bytes32,(address,uint256,uint32,uint32,bytes32,(bytes32,uint256,bytes32,uint256)[],(bytes32,uint256,bytes32,uint256)[],(uint256,bytes32,bytes)[]))"(
